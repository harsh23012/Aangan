...
import { CheckCircle2,Mail,MessageCircle,MapPin } from "lucide-react";
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="mt-10 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8">
						...
						<div className="flex items-center gap-3">
						  ...
						  <span>craftmytrail@gmail.com</span>
						</div>

						<div className="flex items-center gap-3">
						  <MessageCircle size={18} className="text-orange-400" />
						  <span>+91 84345 80656</span>
						</div>

						<div className="flex items-center gap-3">
						  <MapPin size={18} className="text-orange-400" />
						  <span>Vill- Sachai, Kurtha, Arwal (Patna: 70 KMs & Gaya: 50 KMs)</span>
						</div>
					...
					<div className="mt-10 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8">
						...
						<div className="flex items-center gap-3">
							...
							<span>Respect local traditions and customs</span>
						</div>

						<div className="flex items-center gap-3">
							<CheckCircle2 size={18} className="text-green-400" />
							<span>Be comfortable staying with a family</span>
						</div>

						<div className="flex items-center gap-3">
							<CheckCircle2 size={18} className="text-green-400" />
							<span>Be open to village life experiences</span>
						</div>
						<div className="flex items-center gap-3">
							<CheckCircle2 size={18} className="text-green-400" />
							<span>Small group only (5-10 guests)</span>
						</div>
						<div className="flex items-center gap-3">
							<CheckCircle2 size={18} className="text-green-400" />
							<span>Photography should be respectful</span>
						</div>
						<div className="flex items-center gap-3">
							<CheckCircle2 size={18} className="text-green-400" />
							<span>Come with curiosity and an open mind</span>
						</div>
